...
public class DepositEstimates extends JFrame {
    ...
    public DepositEstimates(){

        String column[] = {"DATE","NAME","DEPOSIT_AMOUNT","TOTAL_AMOUNT"};
        String row[][] = {
                {"","     ","      ","     "},
                {"","     ","      ","     "},
                {"","     ","      ","     "},
        ...
        due=new JLabel("        DUE              : ");
        tittle=new JLabel("DEPOSITE CALCULATION");
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    File file=new File("C:/Users/ASUS/Desktop/Project/Deposite.txt");
                    if(!file.exists()){
                        file.createNewFile();
                    }
